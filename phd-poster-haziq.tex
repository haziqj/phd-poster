...
\vspace{-1.5cm}
\begin{figure}[t]
  \includegraphics[width=\linewidth,height=17cm]{figure/binary_probit}
...
% Conclusion -------------------------------------------------------------------
\setbeamercolor{block alerted title}{fg=black,bg=colred} % Change the alert block title colors
\setbeamercolor{block alerted body}{fg=black,bg=white} % Change the alert block body colors
