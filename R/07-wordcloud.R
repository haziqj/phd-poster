...
# Load my text
my.text <- texts(readtext::readtext("../README.md"))
...
textplot_wordcloud(my.text.dfm, colors = gg_colour_hue(6), max.words = Inf,
                   min.freq = 2, scale = c(5.8, 1.8), rot.per = 0.2, random.color = FALSE)
